...
class Config:
    ...
    report_scene_label: str = ""  # 运行场景标签（如：早报 / 晚报）
    web_report_base_url: Optional[str] = None  # Web 详情页基地址（如 https://dsa.example.com）
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            report_scene_label=(os.getenv('REPORT_SCENE_LABEL', '') or '').strip(),
            web_report_base_url=(os.getenv('WEB_REPORT_BASE_URL') or '').strip() or None,
